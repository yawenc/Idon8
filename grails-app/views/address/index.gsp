		...
		<div id="list-address" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="address.charity.label" default="Charity" /></th>
				...
				<g:each in="${addressInstanceList}" status="i" var="addressInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${addressInstance.id}">${fieldValue(bean: addressInstance, field: "charity")}</g:link></td>
